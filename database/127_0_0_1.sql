...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 22 sep 2023 om 08:52
...
--
CREATE DATABASE IF NOT EXISTS `corbijns_webshop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `corbijns_webshop`;
...
('corbijns_web_shop_user', '[{\"db\":\"corbijns_webshop\",\"table\":\"users\"}]'),
('root', '[{\"db\":\"corbijns_webshop\",\"table\":\"users\"}]');
...
('corbijns_web_shop_user', '2023-09-22 06:51:07', '{\"lang\":\"nl\",\"Console\\/Mode\":\"collapse\"}'),
('root', '2023-09-21 14:33:08', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"nl\"}');
